...
**Figure 1 (GIF).** The crossing of the door. The agent that in the control runs died bleeding
out thirty-eight cells from its home, with the unbreakable route active: badly wounded, in
hostile territory, it arrives and crosses. Frame by frame, generated from the run's data.
