...
fig.tight_layout(); fig.savefig(f"{OUT}/fig07_activation_optimum.png",bbox_inches='tight'); plt.close()
print(f"saved -> fig07_activation_optimum.png  peak ten_F={levels[ip]:.1f}, dd={dd[ip]:.3f}")
